...
// things left : completing edit functionality and update DB when we delete medicines
const MedicineList = () => {
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 mb-6">
        <div className="p-4 border-b border-gray-400">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <select className="px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-primary">
                ...
                <tr key={product.id}>
                  ...
                  <td className="py-4 px-7">
                    <div className="flex space-x-2">
                      ...
                      <button className="p-1 text-red-500 hover:text-red-700" onClick={() => handleDelete(product.id)}>
                        <Trash2 size={18} />
                      </button>
                    </div>
                  </td>
        ...
        <div className="px-6 py-4 flex items-center justify-between border-t border-gray-400">
          <div className="text-gray-500 text-sm">
            Showing {paginatedProducts.length} of {products.length} medicines
          </div>
          <div className="flex space-x-2">
            <button
