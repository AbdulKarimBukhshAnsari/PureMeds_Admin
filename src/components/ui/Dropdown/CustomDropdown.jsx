    ...
    <div className="space-y-2" ref={dropdownRef}>
      ...
      <div className="relative">
        <button
          ...
          className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all duration-200 bg-white cursor-pointer flex items-center justify-between text-left ${
            error
        ...
        >
          ...
          >
            <ChevronDown size={20} className={value ? "text-primary" : "text-gray-400"} />
          </motion.div>
        </button>
